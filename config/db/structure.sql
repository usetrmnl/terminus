...
CREATE TYPE public.device_sensor_kind AS ENUM (
    'carbon_dioxide',
    'humidity',
    'pressure',
    'temperature'
...
--
-- Name: device_sensor_source; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.device_sensor_source AS ENUM (
    'device',
    'server'
);
...
--
-- Name: extension_exchange_verb_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.extension_exchange_verb_enum AS ENUM (
    'get',
    'post'
);
...
--
-- Name: extension_kind_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.extension_kind_enum AS ENUM (
    'image',
    'poll',
    'secure',
    'static',
...
CREATE TYPE public.extension_unit_enum AS ENUM (
    'none',
    'minute',
    'hour',
    'day',
...
--
-- Name: extension_verb_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.extension_verb_enum AS ENUM (
    'get',
    'post'
);
...
--
-- Name: palette_kind; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.palette_kind AS ENUM (
    'trmnl',
    'terminus'
);
...
--
-- Name: device_sensor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.device_sensor (
    id integer NOT NULL,
    device_id integer NOT NULL,
    make text NOT NULL,
    model text NOT NULL,
    kind public.device_sensor_kind NOT NULL,
    value double precision DEFAULT 0 NOT NULL,
    unit text NOT NULL,
    source public.device_sensor_source DEFAULT 'device'::public.device_sensor_source NOT NULL,
    created_at timestamp without time zone DEFAULT date_trunc('second'::text, CURRENT_TIMESTAMP) NOT NULL
);


--
-- Name: device_sensor_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.device_sensor ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.device_sensor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.extension (
    ...
    name text NOT NULL,
    label text NOT NULL,
    logo_data jsonb DEFAULT '{}'::jsonb NOT NULL,
    description text,
    kind public.extension_kind_enum DEFAULT 'poll'::public.extension_kind_enum NOT NULL,
    tags text[] DEFAULT '{}'::text[] NOT NULL,
    static_body jsonb DEFAULT '{}'::jsonb CONSTRAINT extension_body_not_null NOT NULL,
    fields jsonb DEFAULT '{}'::jsonb NOT NULL,
    template text,
    data jsonb DEFAULT '{}'::jsonb NOT NULL,
    "interval" integer DEFAULT 1 NOT NULL,
    unit public.extension_unit_enum DEFAULT 'none'::public.extension_unit_enum NOT NULL,
...
--
-- Name: extension_exchange; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.extension_exchange (
    id bigint NOT NULL,
    extension_id integer NOT NULL,
    headers jsonb DEFAULT '{}'::jsonb NOT NULL,
    verb public.extension_exchange_verb_enum DEFAULT 'get'::public.extension_exchange_verb_enum NOT NULL,
...
--
-- Name: extension_exchange_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.extension_exchange ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.extension_exchange_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: extension_home_assistant_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.extension_home_assistant_config (
    id bigint NOT NULL,
    extension_id bigint NOT NULL,
    source_mode text DEFAULT 'entity'::text NOT NULL,
    entity_ids text[] DEFAULT '{}'::text[] NOT NULL,
    endpoint_path text,
    attribute_map jsonb DEFAULT '{}'::jsonb NOT NULL,
    normalize_urls boolean DEFAULT true NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: extension_home_assistant_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.extension_home_assistant_config ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.extension_home_assistant_config_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: extension_model; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.extension_model (
    id integer NOT NULL,
    extension_id integer NOT NULL,
    model_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
--
-- Name: extension_model_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.extension_model ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.extension_model_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.firmware (
    ...
    kind text DEFAULT 'terminus'::text CONSTRAINT firmwares_kind_not_null NOT NULL,
...
--
-- Name: home_assistant_connection; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.home_assistant_connection (
    id bigint NOT NULL,
...
--
-- Name: home_assistant_connection_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.home_assistant_connection ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.home_assistant_connection_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: model_palette; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.model_palette (
    id integer NOT NULL,
    model_id integer NOT NULL,
...
--
-- Name: model_palette_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.model_palette ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.model_palette_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: palette; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.palette (
    ...
    name text NOT NULL,
    label text NOT NULL,
    kind public.palette_kind DEFAULT 'terminus'::public.palette_kind NOT NULL,
    grays integer DEFAULT 0 NOT NULL,
...
--
-- Name: palette_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.palette ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: device_sensor device_sensor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_sensor
    ADD CONSTRAINT device_sensor_pkey PRIMARY KEY (id);
...
--
-- Name: extension_exchange extension_exchange_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_exchange
    ADD CONSTRAINT extension_exchange_pkey PRIMARY KEY (id);


--
-- Name: extension_home_assistant_config extension_home_assistant_config_extension_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_home_assistant_config
    ADD CONSTRAINT extension_home_assistant_config_extension_id_key UNIQUE (extension_id);


--
-- Name: extension_home_assistant_config extension_home_assistant_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_home_assistant_config
    ADD CONSTRAINT extension_home_assistant_config_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.extension
    ADD CONSTRAINT extension_label_key UNIQUE (label);


--
-- Name: extension_model extension_model_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_model
    ADD CONSTRAINT extension_model_pkey PRIMARY KEY (id);


--
-- Name: extension extension_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension
    ADD CONSTRAINT extension_name_key UNIQUE (name);
...
--
-- Name: home_assistant_connection home_assistant_connection_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_assistant_connection
    ADD CONSTRAINT home_assistant_connection_pkey PRIMARY KEY (id);
...
--
-- Name: model_palette model_palette_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.model_palette
    ADD CONSTRAINT model_palette_pkey PRIMARY KEY (id);
...
--
-- Name: palette palette_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.palette
    ADD CONSTRAINT palette_name_key UNIQUE (name);


--
-- Name: palette palette_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: device_sensor_device_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX device_sensor_device_id_index ON public.device_sensor USING btree (device_id);


--
-- Name: device_sensor_kind_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX device_sensor_kind_index ON public.device_sensor USING btree (kind);


--
-- Name: device_sensor_source_index; Type: INDEX; Schema: public; Owner: -
--
...
CREATE UNIQUE INDEX extension_model_extension_id_model_id_index ON public.extension_model USING btree (extension_id, model_id);


--
-- Name: extension_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX extension_name_index ON public.extension USING btree (name);


--
-- Name: extension_unit_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX extension_unit_index ON public.extension USING btree (unit);
...
--
-- Name: model_palette_model_id_palette_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX model_palette_model_id_palette_id_index ON public.model_palette USING btree (model_id, palette_id);


--
-- Name: palette_kind_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX palette_kind_index ON public.palette USING btree (kind);
...
--
-- Name: device_sensor device_sensor_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_sensor
    ADD CONSTRAINT device_sensor_device_id_fkey FOREIGN KEY (device_id) REFERENCES public.device(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: extension_exchange extension_exchange_extension_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_exchange
    ADD CONSTRAINT extension_exchange_extension_id_fkey FOREIGN KEY (extension_id) REFERENCES public.extension(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: extension_home_assistant_config extension_home_assistant_config_extension_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.extension_home_assistant_config
    ADD CONSTRAINT extension_home_assistant_config_extension_id_fkey FOREIGN KEY (extension_id) REFERENCES public.extension(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.extension_model
    ADD CONSTRAINT extension_model_extension_id_fkey FOREIGN KEY (extension_id) REFERENCES public.extension(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: extension_model extension_model_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: model_palette model_palette_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.model_palette
    ADD CONSTRAINT model_palette_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.model(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: model_palette model_palette_palette_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.model_palette
    ADD CONSTRAINT model_palette_palette_id_fkey FOREIGN KEY (palette_id) REFERENCES public.palette(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
('20260503120000_add_home_assistant_source_support.rb'),
