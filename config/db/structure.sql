...
--
-- Name: extension_exchange_extension_id_template_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX extension_exchange_extension_id_template_index ON public.extension_exchange USING btree (extension_id, template);
