...
* *Model*: Synchronizes {trmnl_link} models. New models, as they become available, are added to the database while existing are updated. By default, this checks for updates once a day.
